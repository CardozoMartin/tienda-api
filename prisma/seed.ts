...
import { sincronizarCategorias } from "../src/config/categorias.seed";
...
async function main(): Promise<void> {
  ...
  // Fuente única de verdad: src/config/categorias.seed.ts
  // ─────────────────────────────────────────────

  console.log("📂 Creando categorías (con subcategorías)...");
  const totalCats = await sincronizarCategorias(prisma);
