...
export const ActualizarTemaSchema = z.object({
  ...
  navbarVariante: z.enum(['CLASICO', 'PILL', 'BOUTIQUE', 'BRASILIA']).optional(),
  navbarColorTema: z.enum(['CLARO', 'OSCURO']).optional(),
  cardVariante: z.enum(['CLASICO', 'MODERNO', 'BRASILIA']).optional(),
  footerVariante: z.enum(['CENTRADO', 'COLUMNAS', 'BRASILIA']).optional(),
  botonForma: z.enum(['REDONDEADO', 'CUADRADO']).optional(),
  fuenteKit: z.enum(['MODERNO', 'EDITORIAL', 'IMPACTO', 'MINIMAL', 'BRASILIA']).optional(),
  ...
  tipoSeccionHero: z.enum(['CARRUSEL', 'BANNER', 'HERO_FIJO', 'VIDEO', 'GALERIA', 'BRASILIA']).optional(),
